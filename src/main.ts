...
export class UserListConverter {
  ...
  public userListToCSV = (users: User[]): Blob => {
    ...
    // Générer une feuille Excel
    const worksheet = utils.aoa_to_sheet(rows);
    // Générer un fichier CSV
    let csvContent = utils.sheet_to_csv(worksheet);
    // Remplacer les virgules par des points-virgules dans le contenu CSV
    csvContent = csvContent.replace(/,/g, ";");
    // Créer un Blob contenant le CSV avec le séparateur `;`
...
cest correct comme ca ou je doit maitre  en async ?
