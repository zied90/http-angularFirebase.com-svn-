...
export default FormItem;  et voici le compsent import { FC, useContext, useEffect, useState } from "react";
...
export default Generer;
  actuelement lorsque on arrive a cete page  tand que  tous les champs nest pas renseigner le boutoon disabled  je veux que si  tu arrive a la page  et que le numero de conrtart nest pas renseiller ou lui dit de rensegner  comment faire 
