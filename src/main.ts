...
components:
  ...
  schemas:
    ...
    EndUserType:
      type: string
      enum: ['A2P','ADF','AEP','AGA','AMA','AWS','AXA_ASSISTANCE','AXB','CLI','CLP','COU','JURIDICA','SIEGE','SIEGE_AXAPART','SIEGE_IARDENT','SIEGE_REGLEURS','SOG'] est ce que le swagger bien formater et pas derreur µ? et si ilya des compsent pas utiliser dans upload  tu le supprime
